...
class ItemCardBarangMasuk extends StatelessWidget {
  final BarangMasukModel data;
  final Function()? onTap;
  final Function()? onLongPress;
  const ItemCardBarangMasuk({super.key, required this.data, this.onTap, this.onLongPress});
